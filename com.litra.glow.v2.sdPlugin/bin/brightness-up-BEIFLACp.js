    ...
    (class extends _classSuper {
        ...
        async getCurrentBrightness() {
            try {
                ...
                const match = devices.match(/Brightness: (\d+)%/);
                if (match && match[1]) {
        ...
        async onWillAppear(ev) {
            ...
            try {
                ...
                logToFile(`[onWillAppear] Action initialisée`);
            }
            catch (error) {
        ...
        async onKeyDown(ev) {
            ...
            try {
                ...
                logToFile(`[onKeyDown] Augmentation de la luminosité de ${currentBrightness}% à ${newBrightness}%`);
...
//# sourceMappingURL=brightness-up-BEIFLACp.js.map
