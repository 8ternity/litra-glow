...
// Icône de luminosité avec teinte verdâtre pour l'augmentation
const ICON_BRIGHTNESS_UP = `
<svg xmlns="http://www.w3.org/2000/svg" width="144" height="144" viewBox="0 0 144 144">
  <g fill="none" stroke="#a0e080" stroke-width="4">
    <!-- Cercle extérieur -->
    <circle cx="72" cy="72" r="54" />
    <!-- Lignes de luminosité -->
    <line x1="72" y1="18" x2="72" y2="36" stroke-linecap="round" />
    <line x1="72" y1="108" x2="72" y2="126" stroke-linecap="round" />
    <line x1="18" y1="72" x2="36" y2="72" stroke-linecap="round" />
    <line x1="108" y1="72" x2="126" y2="72" stroke-linecap="round" />
    <line x1="34" y1="34" x2="47" y2="47" stroke-linecap="round" />
    <line x1="97" y1="97" x2="110" y2="110" stroke-linecap="round" />
    <line x1="34" y1="110" x2="47" y2="97" stroke-linecap="round" />
    <line x1="97" y1="47" x2="110" y2="34" stroke-linecap="round" />
    <!-- Curseur central -->
    <circle cx="72" cy="72" r="20" fill="#a0e080" />
    <!-- Symbole plus -->
    <line x1="72" y1="62" x2="72" y2="82" stroke="#ffffff" stroke-width="4" stroke-linecap="round" />
    <line x1="62" y1="72" x2="82" y2="72" stroke="#ffffff" stroke-width="4" stroke-linecap="round" />
  </g>
</svg>`;
...
//# sourceMappingURL=brightness-up-DQmRd3p8.js.map
