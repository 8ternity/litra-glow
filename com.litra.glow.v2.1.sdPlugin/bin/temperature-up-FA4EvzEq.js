...
function logToFile(message) {
    ...
    const logFile = path__namespace.join(logDir, 'temperature-up.log');
...
let TemperatureUpAction = (() => {
    let _classDecorators = [plugin.action({ UUID: 'com.litra.glow.v2.1.temperature.up' })];
    ...
    (class extends _classSuper {
        ...
        async getCurrentTemperature(serialNumber) {
            try {
...
exports.TemperatureUpAction = TemperatureUpAction;
//# sourceMappingURL=temperature-up-FA4EvzEq.js.map
