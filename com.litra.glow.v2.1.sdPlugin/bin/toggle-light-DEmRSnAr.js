...
function logToFile(message) {
    ...
    fs__namespace.appendFileSync(logFile, `[${timestamp}] ${message}\n`);
}
let ToggleLightAction = (() => {
    let _classDecorators = [plugin.action({ UUID: 'com.litra.glow.toggle' })];
...
//# sourceMappingURL=toggle-light-DEmRSnAr.js.map
